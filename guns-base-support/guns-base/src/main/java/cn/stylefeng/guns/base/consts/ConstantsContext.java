...
public class ConstantsContext {
    ...
    public static Integer getDistParentPathLength() {
        return Integer.valueOf((String) CONSTNTS_HOLDER.get("GUNS_DIST_PARENT_PATH_LENGTH"));
    }

    public static BigDecimal getDistWithdrawRatio() {
        return BigDecimal.valueOf(Double.parseDouble((String) CONSTNTS_HOLDER.get("GUNS_DIST_WITHDRAW_RATIO")) / 100);
    }
